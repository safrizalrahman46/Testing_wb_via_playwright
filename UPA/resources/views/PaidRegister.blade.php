        ...
        <div class="col-md-10">
            <div class="card shadow-sm">
                <div class="card-header bg-white">
                    <h5 class="mb-0">Paid TOEIC Exam Registration Form</h5>
                </div>
                <div class="card-body">
                    @if (session('success'))
                    ...
                    <form method="POST" action="{{ route('paid-toeic.register') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <button type="submit" class="btn btn-success">Register for Paid Exam</button>
                    </form>
                </div>
            </div>
        </div>
